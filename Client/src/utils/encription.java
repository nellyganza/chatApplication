...
public class encription {
    ...
    public  String encrypt(String message,String username){
        try {
            ...
            BigInteger sharedsecretkey2  = new BigInteger(accdao.findByUsername(username).get(0).getClickPublicKey());
            String Newstr=" ";
            BigInteger n;
            try {
    ...
    public  String dencrypt(String message,String username3){
       try {
           Registry registry = LocateRegistry.getRegistry(con.getSERVER_IP(),con.getRMIPORT());
           ServerInterface accdao = (ServerInterface) registry.lookup("ServerAccount");
           int position;
           ...
           BigInteger sharedsecretkey2  = new BigInteger(accdao.findByUsername(username3).get(0).getClickPublicKey());
           for (String str1 : str) {
